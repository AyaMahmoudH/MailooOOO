    ...
    public partial class pppp : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => new { x.ID, x.Sizes });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wishlist_Product_ProductID_Sizes",
                        columns: x => new { x.ProductID, x.Sizes },
                        principalTable: "Product",
                        principalColumns: new[] { "ID", "Sizes" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.OrderID, x.ProductID, x.Sizes });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProduct_Product_ProductID_Sizes",
                        columns: x => new { x.ProductID, x.Sizes },
                        principalTable: "Product",
                        principalColumns: new[] { "ID", "Sizes" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "ID", "Sizes", "AdditionDate", "Category", "Description", "Discount", "ImageUrl", "Name", "Price", "Quantity", "dbImage" },
                values: new object[] { 1, 0, "1/17/2025 4:14:02 PM", 1, null, 10m, "~/images/sweet-shirt-girl.jpg", "Black Hoodi", 500m, 5, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, "Beni-Suef", "User", "mailostoreee@gmail.com", "Mai", 1, 15, "Assem", "MaiiiAsss123#44", "b484ad4e-f40d-4f4b-bf15-083cbd80f8e7", "01011895030", new DateTime(2025, 1, 17, 16, 14, 2, 487, DateTimeKind.Local).AddTicks(7414), 1, "MaiAssemAdmin123" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProduct_ProductID_Sizes",
                table: "OrderProduct",
                columns: new[] { "ProductID", "Sizes" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlist_ProductID_Sizes",
                table: "Wishlist",
                columns: new[] { "ProductID", "Sizes" });
        }
